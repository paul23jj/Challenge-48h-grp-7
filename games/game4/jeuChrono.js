...
const cheminNiveauSuivant = '../../index.html'
...
function afficherBoutonSuivant() {
    ...
    if (essais >= 3) {
        ...
        btn.className = 'boutonSuivant';
        // Enregistre la victoire et redirige vers le hub via ARG_complete
        btn.onclick = () => {
            if (typeof ARG_complete === 'function') {
                ARG_complete('game4', Math.round((1 - essais / 3) * 1000), MOT_CODE);
            } else {
